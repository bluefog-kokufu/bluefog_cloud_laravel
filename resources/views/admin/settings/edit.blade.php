    ...
    <form method="POST" action="{{ route('settings.update') }}">
        ...
        <div class="card">
            ...
            <div class="grid2" style="margin-top:10px">
                <div class="field">
                    <label><span class="req">必須</span>消費税率(%)</label>
                ...
                <div class="field">
                    <label><span class="req">必須</span>端数処理</label>
        ...
        <div class="card">
            ...
            <div class="grid2" style="margin-top:10px">
                <div class="field">
                    <label><span class="req">必須</span>会社名</label>
                    <input name="name" value="{{ old('name', $company->name) }}">
                    @error('name')<div class="field-error">{{ $message }}</div>@enderror
                </div>
                <div class="field">
                    <label><span class="req">必須</span>適格請求書発行事業者 登録番号</label>
                ...
                <div class="field">
                    <label><span class="req">必須</span>郵便番号</label>
                ...
                <div class="field">
                    <label><span class="req">必須</span>電話番号</label>
