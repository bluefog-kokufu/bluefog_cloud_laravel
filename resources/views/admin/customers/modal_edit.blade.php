<div>
    ...
    <form method="POST" action="{{ route('customer.update', $customer) }}" id="customer-edit-form">
        ...
        <div class="card">
            ...
            <div class="field"><label><span class="opt">任意</span>住所(市区町村・丁番地)</label><input type="text" name="addr1" value="{{ old('addr1', $customer->addr1) }}"></div>
            <div class="field"><label><span class="opt">任意</span>住所2(建物名・部屋番号)</label><input type="text" name="addr2" value="{{ old('addr2', $customer->addr2) }}"></div>
            <div class="field">
            ...
            <div class="field"><label><span class="opt">任意</span>担当者名</label><input type="text" name="person" value="{{ old('person', $customer->person) }}"></div>
            <div class="field">
            ...
            <div class="field"><label><span class="opt">任意</span>メモ</label><textarea name="memo" rows="4">{{ old('memo', $customer->memo) }}</textarea></div>
        </div>
